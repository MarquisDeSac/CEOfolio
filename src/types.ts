...
/* FEATURES */
export type BgType = 'plum' | 'dot' | 'rose' | 'particle' | 'retro-grid' | 'bit-rain' | 'sunset' | 'starfield' | 'lava-lamp' | 'circuit' | 'aurora' | 'static-noise' | 'equalizer' | 'constellation' | 'holo-mesh' | 'neon-plum' | 'city-lights'

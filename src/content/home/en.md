...
<div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 mb-8">
  <a href="en/projects" class="h-full p-6 rounded-xl border-2! border-solid border-black/20 dark:border-white/20 bg-black/5 dark:bg-white/5 hover:border-sunset-purple hover:bg-sunset-purple/10 transition-colors text-center group no-underline! flex flex-col items-center justify-center gap-2">
  ...
  <a href="en/experiences" class="h-full p-6 rounded-xl border-2! border-solid border-black/20 dark:border-white/20 bg-black/5 dark:bg-white/5 hover:border-sunset-purple hover:bg-sunset-purple/10 transition-colors text-center group no-underline! flex flex-col items-center justify-center gap-2">
  ...
  <a href="en/parcours" class="h-full p-6 rounded-xl border-2! border-solid border-black/20 dark:border-white/20 bg-black/5 dark:bg-white/5 hover:border-sunset-purple hover:bg-sunset-purple/10 transition-colors text-center group no-underline! flex flex-col items-center justify-center gap-2">
  ...
  <a href="en/skills" class="h-full p-6 rounded-xl border-2! border-solid border-black/20 dark:border-white/20 bg-black/5 dark:bg-white/5 hover:border-sunset-purple hover:bg-sunset-purple/10 transition-colors text-center group no-underline! flex flex-col items-center justify-center gap-2">
  ...
  <a href="en/contact" class="h-full p-6 rounded-xl border-2! border-solid border-black/20 dark:border-white/20 bg-black/5 dark:bg-white/5 hover:border-sunset-purple hover:bg-sunset-purple/10 transition-colors text-center group no-underline! flex flex-col items-center justify-center gap-2">

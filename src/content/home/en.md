...
<div class="flex flex-col sm:flex-row items-center justify-center gap-4 mb-4">
  ...
  <a href="/CEOfolio/en/cv" target="_blank" onclick="event.preventDefault(); var w = window.open('/CEOfolio/en/cv', '_blank'); w.onload = function() { w.print(); };" class="flex items-center gap-2 px-6 py-2.5 rounded-full bg-neon-pink border border-neon-pink text-white font-bold hover:brightness-110 transition-all no-underline shadow-[0_0_20px_rgba(255,0,127,0.3)] hover:shadow-[0_0_30px_rgba(255,0,127,0.5)] cursor-pointer">
...
<div class="flex flex-col gap-6 mt-8">
  ...
  <dialog id="modal-cv" class="backdrop:bg-black/60 backdrop:backdrop-blur-sm bg-white dark:bg-[#111] border border-black/10 dark:border-white/10 p-4 md:p-6 rounded-xl text-black dark:text-white w-[95vw] max-w-5xl h-[90vh] m-auto shadow-2xl open:animate-fade-in outline-none">
    ...
    <div class="mt-4 flex justify-end gap-3">
      ...
      <a href="/CEOfolio/en/cv" target="_blank" onclick="event.preventDefault(); var w = window.open('/CEOfolio/en/cv', '_blank'); w.onload = function() { w.print(); };" class="px-5 py-2.5 rounded-lg bg-neon-pink text-white hover:brightness-110 transition-colors font-bold no-underline flex items-center gap-2">

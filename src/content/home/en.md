...
<div class="flex flex-col sm:flex-row items-center justify-center gap-4 mb-4">
  <a href="/CEOfolio/en/cv" class="flex items-center gap-2 px-6 py-2.5 rounded-full bg-neon-pink/10 border border-neon-pink/30 text-neon-pink font-bold hover:bg-neon-pink/20 hover:border-neon-pink transition-all no-underline shadow-[0_0_15px_rgba(255,0,127,0.15)] hover:shadow-[0_0_25px_rgba(255,0,127,0.3)]">
